...
export default async function AdminSettingsPage() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-dark/65">Referrals</h2>
        <ReferralsForm amount={settings.referral_bonus_amount} />
      </section>
      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-dark/65">Loyalty points</h2>
        <LoyaltyForm enabled={settings.loyalty_enabled} rate={settings.loyalty_points_per_1000} />
      </section>
      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-dark/65">Contact &amp; footer</h2>
        <ContactForm settings={settings} />
      </section>
      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-dark/65">Notifications</h2>
